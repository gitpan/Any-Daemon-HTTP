...
The absolute prefix DIRECTORY before the path of the URI, or a CODE
...
=item $obj-E<gt>B<allow>(CLIENT, SESSION, REQUEST, URI)
...
option of L<new()|Any::Daemon::HTTP::Directory/"Constructors">.  These parameters are exclusive (which is slightly
