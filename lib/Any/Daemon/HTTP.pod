...
=item proxies => VHOST|HASH-of-OPTIONS|PACKAGE|ARRAY

[0.24] For OPTIONS, see L<addProxy()|Any::Daemon::HTTP/"Host administration">.  Provide one or an ARRAY of
proxy configurations, either by L<Any::Daemon::HTTP::Proxy|Any::Daemon::HTTP::Proxy>
...
For OPTIONS, see L<addVirtualHost()|Any::Daemon::HTTP/"Host administration">.  Provide one or an ARRAY of
...
=item $obj-E<gt>B<addProxy>(OBJECT|HASH-of-OPTIONS|OPTIONS)
